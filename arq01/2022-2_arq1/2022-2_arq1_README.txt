...
- 8085    v1.0 e v2.0
- CPUSim  v3.9.0
- Icarus  Verilog v.11b2 com GTKWave v3.3.100
- JFLAP   v7.1
   ...
   Menu Iniciar
    |_ Procurar
      |_ Variáveis de ambiente
         |_ Editar as variáveis de ambiente do sistema
            |_ Variáveis de ambiente
               |_ Path
                  |_ Editar
                     |_ Novo
                     |  |_ Procurar
                     |     |_ C:\Icarus_Verilog_v11b2\bin
                     |        |_ OK
                     |_ Novo
                     |  |_ Procurar
                     |     |_ C:\Icarus_Verilog_v11b2\gtkwave\bin
                     |        |_ OK
                     |_ OK
    ...
    para o usuário (user), 
    deverá aparecer uma descrição e a versão instalada:

    C:\Usuario\user>iverilog -v
...
e a extenão (.vvp) deverá ser associada ao arquivo objeto 
cuja execução poderá ser feita como descrito a seguir
...
Caso não seja possível installar, recomendam-se
compiladores gratuitos online
