...
REM
REM path|find /i "C:\Icarus_Verilog_v11b2\bin"         >nul || set path=%path%;C:\Icarus_Verilog_v11b2\bin
REM path|find /i "C:\Icarus_Verilog_v11b2\gtkwave\bin" >nul || set path=%path%;C:\Icarus_Verilog_v11b2\gtkwave\bin
REM
